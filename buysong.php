<?php
	...
	if (isset($_SESSION['user'])){
		...
		$fileName = $rs_songandsinger['singer'] . ' - ' . $rs_songandsinger['song'] . ' - ' . bin2hex(random_bytes(16)) . '.wav';
		...
		//Read audio file
			...
			$newFileName = $rs_songandsinger['singer'] . ' - ' . $rs_songandsinger['song'] . ' - ' . $_SESSION['user'] . '.wav';
