			...
			if ($rs_mypermission['permission'] == "admin"){
				...
				if(isset($_POST['upfilebtn1']) && isset($_POST['upfilesinger']) && isset($_POST['upfilesong'])){
					...
					if ($fileType == "audio/wav"){
						...
						putenv('GOOGLE_APPLICATION_CREDENTIALS=google-api-php-client/audio.json');
						$client = new Google_Client();
						...
						$fileMetadata = new Google_Service_Drive_DriveFile(array('name' => $_POST['upfilesinger'] . " - " . $_POST['upfilesong'] . ".wav"));
						...
						$qr = $conn->prepare("insert into multimedia (id, parentid, song, singer, url, type, owner) values (:id, :parentid, :song, :singer, :url, 'music', 'huynhtiensi');");
